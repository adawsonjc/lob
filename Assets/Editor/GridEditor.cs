...
public class GridEditor : Editor
{
	...
	public override void OnInspectorGUI ()
	{
		...
		//create editor fields in here and they will constantly checked for change, if there is a change, guichanged is set to true and the code inside EndChange
